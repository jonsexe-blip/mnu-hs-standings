...
const NAME_MAP = {
  ...
  'Avalon': 'Avalon',
  "Benilde-St. Margaret's": "Benilde-St Margaret's", "Benilde-St. Margaret's Open": "Benilde-St Margaret's", 'Benilde - St. Margaret Varsity': "Benilde-St Margaret's",
  'Blake': 'Blake', 'Blake Open': 'Blake',
  'Bloomington Ultimate Frisbee HS': 'Bloomington', 'Bloomington Open': 'Bloomington',
  'Cathedral': 'Cathedral', 'Cathedral Boys High School': 'Cathedral', 'Cathedral Ultimate - Griffin': 'Cathedral',
  ...
  'Minneapolis Squall Open Varsity': 'Minneapolis South', 'Minneapolis Squall Varsity': 'Minneapolis South', 'Minneapolis South Open': 'Minneapolis South',
